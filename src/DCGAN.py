...
class DCGAN(LightningModule):
    ...
    def configure_optimizers(self):
        opt_generator = torch.optim.Adam(self.generator.parameters(), lr=2e-4, betas=(0.5, 0.99))
        opt_discriminator = torch.optim.Adam(self.discriminator.parameters(), lr=2e-4, betas=(0.5, 0.99))
